...
int main() {
    ...
    while (true) {
        ...
        cout << endl;
        int len = get_integer("How long of a word would you like?");
        while (!game.is_valid_length(len)) {
                cout << endl << "Not a Valid Length of word!" << endl;
                len = get_integer("How long of a word would you like?");
            }
        cout << endl;
        game.start_new_game(num_guesses,len);
        ...
        while (!game.is_won() && !game.is_lost()) {
            ...
            cout << "There are " << game.get_words_left() << " words left."<<endl;
